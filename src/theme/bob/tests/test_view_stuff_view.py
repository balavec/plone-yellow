...
class ViewsIntegrationTest(unittest.TestCase):
    ...
    def test_stuff_view_is_registered(self):
        view = getMultiAdapter(
            (self.portal['other-folder'], self.portal.REQUEST),
            name='stuff_view'
        )
        self.assertTrue(view.__name__ == 'stuff_view')
        # self.assertTrue(
        #     'Sample View' in view(),
        #     'Sample View is not found in stuff_view'
        # )

    def test_stuff_view_not_matching_interface(self):
